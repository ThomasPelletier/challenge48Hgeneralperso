 ...
 <div class="py-8 pl-12 flex justify-center mx-[40%] rounded-xl">
        ...
        -->
				<div className="px-5 pb-5">
					<a href="#">
						<h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-black">{{ leProduit.nom }}</h5>
            <span className="font-bold text-gray-900 dark:text-black">{{ leProduit.description }}</span>
					</a>
					<!--
...
export default {
  ...
  mounted() {
    this.leProduit = this.produit;
    this.showATC = this.showAAP;
  }
}
</script>
